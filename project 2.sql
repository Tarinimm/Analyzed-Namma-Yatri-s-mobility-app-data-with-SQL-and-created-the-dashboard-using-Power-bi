...
select sum ( searches_got_estimate) serches from trips_details4; 

--total searches for quotes

select sum (searches_for_quotes) serches from trips_details4;

--total searches which got quotes

select sum (searches_got_quotes) serches from trips_details4;

--total driver cancelled

select * from trips_details4;

select count(*) -sum (driver_not_cancelled) serches from trips_details4;

--total otp entered

select sum (otp_entered) serches from trips_details4;

--total end ride

select sum (end_ride) serches from trips_details4;
